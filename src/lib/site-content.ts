export const siteConfig = {
  ...
  address: "Adullam Cave Christian Network, Lagos, Nigeria",
  phone: "+234 800 000 0000",
  serviceTimes: [
    { day: "Sunday", time: "9:00 AM — Worship Service" },
    { day: "Wednesday", time: "6:00 PM — Bible Study" },
...
export const givingInfo = {
  ...
  accountName: "Adullam Cave Christian Network",
...
export const pillars = [
  ...
  },
  {
    name: "Propagation",
    description:
      "Sending the Gospel outward — planting, discipling, and multiplying the message of the Kingdom beyond these walls.",
  },
  {
    name: "Community Lifestyle",
    description:
      "Life together — authentic fellowship, accountability, and care that reflects the family of God in everyday living.",
  },
];
